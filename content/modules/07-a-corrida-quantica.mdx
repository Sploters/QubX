...
- 📄 [Google: Quantum Supremacy Using a Programmable Superconducting Processor (Nature, 2019)](https://www.nature.com/articles/s41586-019-1666-5) — o paper original do Sycamore
- 📄 [Google: Quantum Error Correction Below the Surface Code Threshold (Nature, 2024)](https://www.nature.com/articles/s41586-024-08449-y) — o resultado do Willow que mudou o campo
- 🌐 [IBM Quantum Roadmap](https://www.ibm.com/quantum/roadmap) — o plano público e detalhado da IBM até 2033
- 📄 [Gibney: China's Quantum Satellite Achieves 'Spooky Action' at Record Distance (Nature News)](https://www.nature.com/articles/d41586-021-02052-y) — o avanço chinês em comunicação quântica via satélite
- 🌐 [The Quantum Insider: Quantum Computing Market Report](https://thequantuminsider.com/) — cobertura de notícias e análises do mercado quântico

...
- 📄 [Preskill: Quantum Computing in the NISQ Era and Beyond (arXiv)](https://arxiv.org/abs/1801.00862) — o roadmap teórico mais influente da área
- 🎥 [IBM Research: What is a Qubit?](https://www.youtube.com/watch?v=zOGNoDO7mcU) — explicação visual diretamente dos engenheiros da IBM
- 📄 [Aspect et al.: Experimental Tests of Bell's Inequalities (1982)](https://journals.aps.org/prl/abstract/10.1103/PhysRevLett.49.91) — o paper que confirmou o emaranhamento quântico (Nobel 2022)
- 🎓 [IBM Quantum Learning: Introduction to Quantum Computing](https://learning.quantum.ibm.com/course/basics-of-quantum-information) — curso gratuito e interativo da IBM
- 🎥 [MinutePhysics: Bell's Theorem — The Quantum Venn Diagram Paradox](https://www.youtube.com/watch?v=zcqZHYo7ONs) — emaranhamento e desigualdades de Bell em 8 minutos

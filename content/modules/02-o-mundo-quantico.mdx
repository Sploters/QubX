...
- 🎥 [Veritasium: O Experimento da Dupla Fenda](https://www.youtube.com/watch?v=A9tKncAdlHQ) — o experimento mais perturbador da física explicado com maestria
- 📄 [The Feynman Lectures on Physics: Quantum Behavior (Cap. 1)](https://www.feynmanlectures.caltech.edu/III_01.html) — acesso gratuito ao clássico de Feynman
- 🎥 [PBS Space Time: Schrödinger's Cat](https://www.youtube.com/watch?v=UjaAxUO6-Uw) — a interpretação quântica aprofundada
- 📚 [Carlo Rovelli: Helgoland](https://www.amazon.com.br/Helgoland-Rovelli-Carlo/dp/0593328884) — a mecânica quântica narrada como história de descoberta
- 📄 [Heisenberg's Uncertainty Principle — Physics Today](https://physicstoday.scitation.org/doi/10.1063/1.3086963) — o artigo seminal de Heisenberg em contexto

...
- 📄 [Kimble: The Quantum Internet (Nature, 2008)](https://www.nature.com/articles/nature07127) — o artigo fundacional sobre internet quântica global
- 📄 [Degen, Reinhard & Cappellaro: Quantum Sensing (Reviews of Modern Physics, 2017)](https://journals.aps.org/rmp/abstract/10.1103/RevModPhys.89.035002) — revisão completa de sensores quânticos e suas aplicações
- 🎥 [Veritasium: Quantum Teleportation — How It Really Works](https://www.youtube.com/watch?v=DxQK1WDYI_k) — desmistificando o teletransporte quântico
- 🌐 [Amazon Braket](https://aws.amazon.com/braket/) — plataforma da AWS para computação quântica na nuvem (IonQ, Rigetti, IBM)
- 📚 [The Quanta Magazine: Quantum Science Coverage](https://www.quantamagazine.org/tag/quantum-computing/) — jornalismo científico de alta qualidade sobre os últimos avanços quânticos

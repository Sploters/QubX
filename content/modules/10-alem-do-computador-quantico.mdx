...
O <Term id="teletransporte-quantico">**teletransporte quântico**</Term> já foi demonstrado experimentalmente. Mas não funciona como no Star Trek.
...
<div className="my-6 grid grid-cols-1 md:grid-cols-2 gap-4">
  <figure className="flex flex-col items-center gap-2">
    <div className="rounded-xl overflow-hidden border border-border/50 bg-surface/20 p-2 w-full">
      <img src="/images/IBM-Q-System-One-display.png" alt="IBM Q System One" className="w-full rounded-lg block"/>
    </div>
    <figcaption className="text-xs text-text-secondary text-center">
      IBM Q System One — primeiro computador quântico integrado em gabinete hermético.
      <span className="text-text-muted"> — IBM Research</span>
    </figcaption>
  </figure>
  <figure className="flex flex-col items-center gap-2">
    <div className="rounded-xl overflow-hidden border border-border/50 bg-surface/20 p-2 w-full">
      <img src="/images/computador-quantico-IBM-1.png" alt="Computador quântico IBM" className="w-full rounded-lg block"/>
    </div>
    <figcaption className="text-xs text-text-secondary text-center">
      Hardware IBM Quantum com refrigerador de diluição — mantido a 15 milikelvin.
      <span className="text-text-muted"> — IBM Research</span>
    </figcaption>
  </figure>
</div>
...
<svg viewBox="0 0 720 200" className="w-full my-8 rounded-xl" style={{background:'#13131f', padding:'20px'}}>
  ...
  <text x="100" y="16" textAnchor="middle" fill="#94a3b8" fontSize="9" fontFamily="Inter, sans-serif">Vantagem quântica</text>
  <text x="100" y="28" textAnchor="middle" fill="#94a3b8" fontSize="9" fontFamily="Inter, sans-serif">em otimização</text>
  ...
  <text x="420" y="14" textAnchor="middle" fill="#06b6d4" fontSize="9" fontFamily="Inter, sans-serif" fontWeight="bold">Simulação molecular</text>
  <text x="420" y="28" textAnchor="middle" fill="#94a3b8" fontSize="9" fontFamily="Inter, sans-serif">para fármacos</text>
...
<GlossaryIndex terms={['qubit', 'superposicao', 'emaranhamento', 'teletransporte-quantico']} />

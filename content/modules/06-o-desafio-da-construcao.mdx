...
O que parece uma escultura de arte moderna é, na verdade, um dos sistemas de engenharia mais sofisticados do mundo.
 Cada camada cilíndrica representa um estágio de resfriamento progressivo — da temperatura ambiente (topo) até os 15 millikelvins onde os qubits vivem (fundo).

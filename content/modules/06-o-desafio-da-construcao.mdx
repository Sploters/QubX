...
![O interior de um refrigerador de diluição da IBM, mostrando a complexa fiação de micro-ondas](/images/ibm-device.png)
...
<svg viewBox="0 0 700 220" className="w-full my-8 rounded-xl" style={{background:'#13131f', padding:'20px'}}>
  {/* Lado esquerdo: qubits físicos ruidosos */}
  <text x="160" y="22" textAnchor="middle" fill="#94a3b8" fontSize="11" fontFamily="Inter, sans-serif">~1.000 QUBITS FÍSICOS (ruidosos)</text>
  {/* Grid de mini-qubits */}
  {[0,1,2,3,4].map((row) =>
    [0,1,2,3,4,5].map((col) => {
      const x = 30 + col * 38
      ...
      return (
        <g key={`${row}-${col}`}>
          <rect x={x} y={y} width="26" height="22" rx="4" fill="#1e1e30" stroke={isError ? "#ef4444" : "#334155"} strokeWidth={isError ? 1.5 : 1}/>
          <text x={x+13} y={y+15} textAnchor="middle" fill={isError ? "#ef4444" : "#475569"} fontSize="9" fontFamily="monospace">{isError ? "✗" : "q"}</text>
        </g>
      )
    })
  )}
  <text x="160" y="205" textAnchor="middle" fill="#ef4444" fontSize="9" fontFamily="Inter, sans-serif">erros acontecem (~0,1% por operação)</text>

  {/* Seta */}
  <line x1="340" y1="110" x2="395" y2="110" stroke="#a78bfa" strokeWidth="2.5"/>
  <polygon points="395,104 408,110 395,116" fill="#a78bfa"/>
  <text x="372" y="98" textAnchor="middle" fill="#a78bfa" fontSize="9" fontFamily="Inter, sans-serif">QEC</text>
  <text x="372" y="130" textAnchor="middle" fill="#a78bfa" fontSize="9" fontFamily="Inter, sans-serif">correção</text>

  {/* Lado direito: 1 qubit lógico */}
  <rect x="415" y="65" width="120" height="90" rx="10" fill="#1e1e30" stroke="#06b6d4" strokeWidth="2"/>
  <text x="475" y="95" textAnchor="middle" fill="#06b6d4" fontSize="12" fontFamily="Inter, sans-serif" fontWeight="bold">1 QUBIT</text>
  <text x="475" y="112" textAnchor="middle" fill="#06b6d4" fontSize="12" fontFamily="Inter, sans-serif" fontWeight="bold">LÓGICO</text>
  <text x="475" y="130" textAnchor="middle" fill="#94a3b8" fontSize="10" fontFamily="Inter, sans-serif">livre de erros</text>
  <text x="475" y="200" textAnchor="middle" fill="#06b6d4" fontSize="9" fontFamily="Inter, sans-serif">tolerante a falhas</text>

  {/* Balão explicativo */}
  <text x="555" y="50" textAnchor="middle" fill="#94a3b8" fontSize="9" fontFamily="Inter, sans-serif">1.000 físicos</text>
  <text x="555" y="62" textAnchor="middle" fill="#94a3b8" fontSize="9" fontFamily="Inter, sans-serif">→ 1 lógico</text>
</svg>
